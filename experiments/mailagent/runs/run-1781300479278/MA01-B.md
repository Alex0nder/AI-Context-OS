...
- **No Re-extraction**: Subsequent reads do not re-parse the email; they retrieve the stored OTP directly.
- **Conditions for Null**: OTP extraction may return null if:
  - The OTP is embedded in an image or SVG.
  - The code is alphanumeric or in an attachment.
...
This structured approach ensures that OTP extraction is efficient and reliable, minimizing false positives and maximizing the accuracy of the extracted codes.
