...
2. **Run Production Tests**:
   - For a full suite of production tests, execute:
     ...
     npm run test:prod
     ```
   - For a smoke test (CI post-deploy), use:
     ```bash
...
5. **Check Results**:
   - Review the output for any errors or failures and address them as needed.

For more detailed instructions, refer to the **[docs/AUTOTESTS.md](docs/AUTOTESTS.md)**.
