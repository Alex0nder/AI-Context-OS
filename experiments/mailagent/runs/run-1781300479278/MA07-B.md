...
- **POST** `/open`
  - One-shot: create, wait, extract, delete inbox.
...
- **GET** `/:id/threads/:threadId/messages`
  - Get messages in a specific thread of an inbox.
...
- **GET** `/:id/messages/:messageId/raw`
  - Get raw MIME content of a specific message.
  
- **GET** `/:id/messages/:messageId/attachments`
  - Get metadata of attachments for a specific message.
  
- **GET** `/:id/messages/:messageId/attachments/:attachmentId`
  - Get bytes or JSON of a specific attachment.
  
- **GET** `/:id/extract/presets`
  - Retrieve structured extract presets for a specific inbox.
  
- **GET** `/:id/extract`
  - Get the latest message verification DTO for a specific inbox.
