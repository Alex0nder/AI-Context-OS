...
1. **Install the MailAgent QA SDK**:
   - In your test project, install the SDK:
     ```bash
...
3. **Run the Tests**:
   - Execute your Playwright tests as you normally would, ensuring that the MailAgent API URL and API key are set in your environment.
