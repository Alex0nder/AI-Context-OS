...
- **Whitelisted directories**: File moves must only occur within whitelisted bookmark directories, which are defined in the application.
- **Audit trail**: Skipped folders or paths must be logged in the audit trail to maintain transparency and accountability in file operations.
