...
- **Headless Mode Check**: If the application is running in headless mode (indicated by the `--headless` command line argument), it bypasses the permission request if the status is not determined.
