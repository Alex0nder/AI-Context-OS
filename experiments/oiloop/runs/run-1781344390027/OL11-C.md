...
- **Properties**:
  - `id`: A unique identifier (UUID) for the draft.
  ...
  - `displayName`: The name of the chat or user to whom the message is directed.
  - `body`: The content of the message to be sent.
  - `dbID`: An optional database identifier for the draft.

- **Computed Property**:
  - `previewLine`: A string that provides a preview of the draft, formatted as "Reply in [type] to [displayName]".
